...
const getLoader = generators.getLoader;
const getPlugin = generators.getPlugin;
const getOutput = generators.getOutput;
const getResolver = generators.getResolver;
const getEntry = generators.getEntry;
const getPostCSS = generators.getPostCSS;
const getExternals = generators.getExternals;
